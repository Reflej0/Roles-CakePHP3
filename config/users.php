...
$config = [
    'Users' => [
        ...
        /* Esta linea quiere decir que realmente el controller de usuarios esta en:
         *      vendor/CakeDC/Users/Src/Controller/UsersController.
         *      probar de eliminar esa ubicación y fijarse si anda, esto es porque es un plugin.
         *      además el model y template(vista) de users va a estar en la misma ubicación no donde esta siempre.
                   */
        ...
        'Email' => [ // Esto se desactiva sino hay que implementar que el Cake pueda enviar mails.
        ...
        'Registration' => [
            ...
            'ensureActive' => false,
            // El rol por defecto de los usuarios es usuario.
            'defaultRole' => 'usuario',
        ],
        'reCaptcha' => [
        ...
        'Tos' => [ // Esto también se desactiva no tiene importancia leer los TOS.
